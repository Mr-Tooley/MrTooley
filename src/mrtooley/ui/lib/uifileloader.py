...
Posted especially for: https://github.com/Khufos/Pyqt6-Title-hide-and-window-move/issues/1
after I was googling for a stupid error with loading from Qt resources.
...
class MainWindow(QMainWindow):
    def __init__(self):
        QMainWindow.__init__(self)  # I hate super() btw. It violates the zen of Python.
...
class UiFileLoader(QUiLoader):
    ...
    def load_ui(self, ui_file: str | Path, parent_widget: QWidget):
